...
public record ResponseFrame(object? Request, byte[] Payload);
...
public class CommandResponse
{
    ...
    public static CommandResponse Single(object? request, byte[] payload) => new(new ResponseFrame(request, payload));
} 