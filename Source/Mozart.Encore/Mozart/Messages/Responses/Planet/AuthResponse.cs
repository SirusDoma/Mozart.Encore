...
public partial class AuthResponse : IMessage
{
    ...
    public required TimeBlockSubscriptionInfo TimeBlockSubscription { get; init; }

    public class TimeBlockSubscriptionInfo : SubMessage
    {
        [StringMessageField(order: 0, maxLength: 2, nullTerminated: false)]
        public BillingCode Billing { get; init; } = BillingCode.TB;

        [MessageField<TimeBlockExpiryCodec>(order: 1)]
