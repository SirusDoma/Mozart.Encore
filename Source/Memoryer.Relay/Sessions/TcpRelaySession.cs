...
public class TcpRelaySession : Encore.Sessions.TcpSession, IRelayPeer
{
    ...
    public TcpRelaySession(TcpClient client, IOptions<RelayOptions> options, IMessageFramerFactory framer,
