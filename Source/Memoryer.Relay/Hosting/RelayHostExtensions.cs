...
public static class RelayHostExtensions
{
    public static IServiceCollection AddTcpRelayServices(this IServiceCollection services)
    {
        ...
        services.AddSingleton<TcpRelaySessionManager>(p =>
            new TcpRelaySessionManager(p.GetService<IUdpRelayPeerRegistry>()));
    ...
    {
        // UDP relay framing / reliability
        services.AddSingleton<IUdpRelayFrameCodec, UdpRelayFrameCodec>();
