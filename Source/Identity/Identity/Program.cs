...
{
    public static Version Version        => new(4, 7, 0);
    public static Version NetworkVersion => new(5, 89, 0);
        ...
        return Host.CreateDefaultBuilder(args)
            ...
            .ConfigureServices((context, services) =>
            {
                ...
                services.AddDbContextFactory<MainDbContext>((provider, builder) =>
                {
                    ...
                    _ = options.Driver switch
                    {
                        ...
                        DatabaseDriver.Sqlite =>
                            ...
                            {
                                ctx.MigrationsAssembly("Identity.Migrations.Sqlite");
                        ...
                        DatabaseDriver.SqlServer =>
                            ...
                            {
                                ctx.MigrationsAssembly("Identity.Migrations.SqlServer");
                                if (options.CommandTimeout != null)
                                    ctx.CommandTimeout(options.CommandTimeout.Value);
                        ...
                        DatabaseDriver.MySql =>
                            ...
                            {
                                ctx.MigrationsAssembly("Identity.Migrations.MySql");
                                if (options.CommandTimeout != null)
                                    ctx.CommandTimeout(options.CommandTimeout.Value);
                        ...
                        DatabaseDriver.Postgres =>
                            ...
                            {
                                ctx.MigrationsAssembly("Identity.Migrations.Postgres");
                                if (options.CommandTimeout != null)
                                    ctx.CommandTimeout(options.CommandTimeout.Value);
                ...
                services.AddSingleton<Encore.Services.IAuthSessionTokenGenerator,
                    Encore.Services.CompactGuidAuthSessionTokenGenerator>();
