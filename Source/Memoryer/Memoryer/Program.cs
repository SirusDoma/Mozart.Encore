...
public class Program
{
    ...
    public static Version NetworkVersion => new(7, 55, 0);
                ...
                services.AddDbContextFactory<MainDbContext>((provider, builder) =>
                {
                    ...
                    _ = options.Driver switch
                    {
                        ...
                        DatabaseDriver.Sqlite =>
                            ...
                            {
                                ctx.MigrationsAssembly("Memoryer.Migrations.Sqlite");
                        ...
                        DatabaseDriver.SqlServer =>
                            ...
                            {
                                ctx.MigrationsAssembly("Memoryer.Migrations.SqlServer");
                                if (options.CommandTimeout != null)
                                    ctx.CommandTimeout(options.CommandTimeout.Value);
                        ...
                        DatabaseDriver.MySql =>
                            ...
                            {
                                ctx.MigrationsAssembly("Memoryer.Migrations.MySql");
                                if (options.CommandTimeout != null)
                                    ctx.CommandTimeout(options.CommandTimeout.Value);
                        ...
                        DatabaseDriver.Postgres =>
                            ...
                            {
                                ctx.MigrationsAssembly("Memoryer.Migrations.Postgres");
                                if (options.CommandTimeout != null)
                                    ctx.CommandTimeout(options.CommandTimeout.Value);
