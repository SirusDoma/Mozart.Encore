...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Encore.Data.Entities.AcquiredMusic", b =>
                {
            ...
            modelBuilder.Entity("Encore.Data.Entities.AttributiveItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Encore.Data.Entities.AuthSession", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer")
                        .HasColumnName("USER_INDEX_ID");
            ...
            modelBuilder.Entity("Encore.Data.Entities.GiftItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Encore.Data.Entities.GiftMusic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Encore.Data.Entities.UserMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Encore.Data.Entities.UserRanking", b =>
                {
            ...
            modelBuilder.Entity("Encore.Data.Entities.UserRankingExtended", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Encore.Data.Entities.UserRanking", b =>
                {
                    b.HasOne("Mozart.Data.Entities.User", null)
                        .WithOne("UserRanking")
                        .HasForeignKey("Encore.Data.Entities.UserRanking", "UserId");
                });
            ...
            modelBuilder.Entity("Encore.Data.Entities.UserRankingExtended", b =>
                {
                    b.HasOne("Mozart.Data.Entities.User", null)
                        ...
                        .HasForeignKey("Encore.Data.Entities.UserRankingExtended", "UserId");
                });
