...
public static class RegisterEndpoint
{
        ...
        CancellationToken cancellationToken)
    {
        using (logger.BeginScope("Register"))
        {
            ...
            user.Equipments.Face = (short)(request.Gender == Gender.Female ? 36 : 35);
            ...
            string token = await authService.Authenticate(new Encore.Data.Entities.UsernamePasswordCredentialRequest()
            {
