...
public class Program
{
    ...
    public static Version NetworkVersion => new(6, 65, 0);
    ...
    public static IHostBuilder CreateHostBuilder(string[] args, IConfiguration config)
    {
        return Host.CreateDefaultBuilder(args)
            ...
            .ConfigureServices((context, services) =>
            {
                ...
                services.AddDbContextFactory<MainDbContext>((provider, builder) =>
                {
                    ...
                    _ = options.Driver switch
                    {
                        ...
                        DatabaseDriver.Sqlite =>
                            ...
                            {
                                ctx.MigrationsAssembly("IdentityP2.Migrations.Sqlite");
                        ...
                        DatabaseDriver.SqlServer =>
                            ...
                            {
                                ctx.MigrationsAssembly("IdentityP2.Migrations.SqlServer");
                                if (options.CommandTimeout != null)
                                    ctx.CommandTimeout(options.CommandTimeout.Value);
                        ...
                        DatabaseDriver.MySql =>
                            ...
                            {
                                ctx.MigrationsAssembly("IdentityP2.Migrations.MySql");
                                if (options.CommandTimeout != null)
                                    ctx.CommandTimeout(options.CommandTimeout.Value);
                        ...
                        DatabaseDriver.Postgres =>
                            ...
                            {
                                ctx.MigrationsAssembly("IdentityP2.Migrations.Postgres");
                                if (options.CommandTimeout != null)
                                    ctx.CommandTimeout(options.CommandTimeout.Value);
                ...
                services.AddSingleton<IAuthSessionTokenGenerator, CompactGuidAuthSessionTokenGenerator>();
