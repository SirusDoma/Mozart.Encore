...
Download and extract the IdentityP2 server binary from [here](https://github.com/SirusDoma/Mozart.Encore/releases/latest).
...
| Project                                          | Description                                            |
|--------------------------------------------------|--------------------------------------------------------|
| [IdentityP2](IdentityP2/)                        | Executable, controllers, messages, and CLI tasks       |
| [IdentityP2.Web](IdentityP2.Web/)                | HTTP host that compiles the shared `Encore.Web` source |
| [IdentityP2.Server](IdentityP2.Server/)          | Build-specific game and protocol logic                 |
| [IdentityP2.Data](IdentityP2.Data/)              | Build-specific EF Core data model and metadata parsers |
| [IdentityP2.Migrations](IdentityP2.Migrations/)  | Database migrations organized by provider              |
...
> See [AuthParameters](IdentityP2/Utilities/AuthParameters.cs) and [AuthParameterRsaCipher](IdentityP2/Utilities/AuthParameterRsaCipher.cs) for details about encoding and decoding `encrypted_parameters`.
>
