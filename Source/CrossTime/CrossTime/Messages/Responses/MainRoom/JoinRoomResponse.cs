...
public class JoinRoomResponse : IMessage
{
    ...
    public class AlbumMusicInfo : SubMessage
    {
        [MessageField(order: 0)]
    ...
    public class RoomInfo : SubMessage
    {
        ...
        [CollectionMessageField(order: 9, minCount: 7, maxCount: 7)]
        public IReadOnlyList<RoomSlotInfo> Slots { get; init; } = [];

        [CollectionMessageField(order: 10, prefixSizeType: TypeCode.Int32)]
        public IReadOnlyList<int> Skills { get; init; } = [];

        [MessageField<MessageFieldCodec<short>>(order: 11)]
        ...
        [CollectionMessageField(order: 14, minCount: 12, maxCount: 12)]
        public IReadOnlyList<AlbumMusicInfo>? AlbumMusic { get; init; }
    }
