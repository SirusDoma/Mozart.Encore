...
namespace CrossTime.Workers.Gateway;

public interface IChannelSessionManager : ITcpSessionManager<ChannelSession>
{
...
public class ChannelSessionManager : TcpSessionManager<ChannelSession>, IChannelSessionManager
{
