...
public interface IScoreTracker
{
    ...
    void UpdateLife(Session session, int sequence, int life, uint score);
    void UpdateJamCombo(Session session, int sequence, int combo, uint score);
...
public class ScoreTracker : IScoreTracker
{
    ...
    public void UpdateLife(Session session, int sequence, int life, uint score)
    {
    ...
    public void UpdateJamCombo(Session session, int sequence, int jamCombo, uint score)
    {
    ...
    public void Untrack(Session session)
    {
        ...
        lock (_mutex)
        {
            state = _states.SingleOrDefault(s => s.Session == session);
            if (state == null)
                return;
