...
public enum RequestCommand : ushort
{
    ...
    SetRoomMode         = 0x0BCC, // 3020
    ToggleTeamMode      = 0x0BCE, // 3022
...
public enum ResponseCommand : ushort
{
    ...
    ServerLogin          = 0x03E9, // 1001
    GetChannelList       = 0x03EB, // 1003
    ChannelLogin         = 0x03ED, // 1005
    Authorize            = 0x03F0, // 1008
    ConnectGateway       = 0x03F4, // 1012
