...
Download and extract the CrossTime server binary from [here](https://github.com/SirusDoma/Mozart.Encore/releases/latest).
...
| Project                                        | Description                                            |
|------------------------------------------------|--------------------------------------------------------|
| [CrossTime](CrossTime/)                        | Executable, controllers, messages, and CLI tasks       |
| [CrossTime.Web](CrossTime.Web/)                | HTTP host that compiles the shared `Encore.Web` source |
| [CrossTime.Server](CrossTime.Server/)          | Build-specific game and protocol logic                 |
| [CrossTime.Data](CrossTime.Data/)              | Build-specific EF Core data model and metadata parsers |
| [CrossTime.Migrations](CrossTime.Migrations/)  | Database migrations organized by provider              |
